...
export const FlameIcon: React.FC<FlameIconProps> = ({
  ...
  // Cuando está inactivo: llama gris con el centro blanco y ligera opacidad.
  const activeClasses = active ? '' : 'opacity-70';
