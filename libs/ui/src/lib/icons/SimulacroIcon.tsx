...
export const SimulacroIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 23 30"
    fill="none"
  ...
  >
    ...
    <path d="M0 2C0 0.89543 0.895431 0 2 0H20.5C21.6046 0 22.5 0.895431 22.5 2V7.5H0V2Z" fill="#FFA1A1"/>
