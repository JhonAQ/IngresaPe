...
export const temarioMock: TemaData[] = [
  {
    ...
    resumenData: {
      ...
      tipExamen: "Diferencia clásica: Las vegetales tienen celular de celulosa."
    }
  },
  {
    id: 2,
    ...
    resumenData: {
      introduccion: "El metabolismo es el conjunto de reacciones químicas...",
      imagenExplicativa: false,
      puntosClave: [
        { titulo: "Catabolismo", texto: "Degrada moléculas complejas." },
        { titulo: "Anabolismo", texto: "Construye moléculas complejas." }
      ],
