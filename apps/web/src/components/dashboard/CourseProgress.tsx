...
export function CourseProgress() {
  return (
    <button className="px-4 py-3 flex items-center justify-between bg-white hover:bg-surface-50 transition-all w-full text-left rounded-2xl border-2 border-surface-200 shadow-[0_4px_12px_-4px_rgba(0,0,0,0.1)] active:translate-y-[2px] active:shadow-none">
