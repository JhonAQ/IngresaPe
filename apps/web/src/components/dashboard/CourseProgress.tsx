...
export function CourseProgress() {
  return (
    <button className="px-4 py-3 flex items-center justify-between bg-white hover:bg-slate-50 transition-all w-full text-left rounded-2xl shadow-[0px_8px_24px_rgba(0,0,0,0.08)] active:translate-y-[2px] active:shadow-sm ring-1 ring-black/5">
