...
export const FichaOpticaModal = ({
  ...
  return (
    <div
      className={`absolute inset-0 bg-slate-900/50 z-[100] backdrop-blur-sm transition-opacity duration-300 ${
        isOpen
    ...
    >
      ...
      >
        ...
        <div className="p-6 bg-white shrink-0 shadow-[0_-10px_20px_rgba(0,0,0,0.05)] flex gap-4 z-20">
          <button
            onClick={onClose}
            className="bg-slate-100 hover:bg-slate-200 text-slate-500 font-black p-4 rounded-2xl active:scale-95 transition-all"
          >
            <ChevronLeft size={24} />
          </button>
          <button
