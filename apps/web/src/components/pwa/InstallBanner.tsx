  ...
  return (
    <AnimatePresence>
      {canShowBanner && (
        ...
        >
          <div className="relative bg-gradient-to-r from-[#f3e8ff] via-white to-[#fff7ed] border-b border-amber-200/50">
            {/* Decorative orbs */}
            <div className="absolute -left-6 -top-6 w-20 h-20 rounded-full bg-purple-200/40 blur-2xl" />
            <div className="absolute -right-6 -bottom-6 w-20 h-20 rounded-full bg-amber-200/40 blur-2xl" />
            ...
            <div className="relative flex items-center gap-3 px-4 py-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                  <Sparkles size={12} className="text-amber-500" strokeWidth={3} />
              ...
              <button
                ...
                className="shrink-0 h-9 px-3 bg-amber-400 text-amber-950 font-black text-[11px] rounded-xl border-b-[3px] border-amber-500 active:border-b-0 active:translate-y-[3px] transition-all flex items-center gap-1.5"
              >
