...
// ============================================================================
const examLibrary = [
  { id: 1, title: 'Admisión 2024', phase: 'FASE II', type: 'ORDINARIO', year: '2024', status: 'new', score: null },
  { id: 2, title: 'Admisión 2024', phase: 'FASE I', type: 'ORDINARIO', year: '2024', status: 'completed', score: 65 },
  { id: 3, title: 'CEPRUNSA 2024', phase: 'II FASE', type: 'CEPRUNSA', year: '2024', status: 'new', score: null },
  { id: 4, title: 'Extraordinario', phase: 'ÚNICA 2024', type: 'EXTRA', year: '2024', status: 'new', score: null },
  { id: 5, title: 'Admisión 2023', phase: 'FASE II', type: 'ORDINARIO', year: '2023', status: 'completed', score: 82 },
  { id: 6, title: 'CEPRUNSA 2023', phase: 'I FASE', type: 'CEPRUNSA', year: '2023', status: 'locked', score: null },
];
    ...
    <div className="flex-1 overflow-y-auto hide-scrollbar flex flex-col pb-32 bg-white relative">
      ...
      <div className="sticky top-0 z-50 bg-white shadow-sm border-b-2 border-slate-100">
        <header className="flex items-center px-4 py-3 bg-white">
          ...
          >
            ...
            <span className="font-extrabold text-[13px] uppercase tracking-widest mt-0.5">Regresar</span>
          </Link>
        </header>
      ...
      <div className="px-5 pt-6 pb-4 text-center">
        <h2 className="font-black text-[32px] leading-[1.1] tracking-tight">
          <span className="text-slate-800">Archivo</span><br/>
      ...
      <div className="px-5 py-2">
        <AnimatePresence mode="popLayout">
          {filteredExams.length > 0 ? (
                ...
                return (
                  <motion.div 
                    ...
                    className={`bg-white rounded-[1.5rem] border-2 border-slate-200 border-b-[6px] p-4 flex flex-col items-center text-center transition-all cursor-pointer relative
                      ${isLocked ? 'opacity-70' : 'active:border-b-[2px] active:translate-y-[4px] hover:bg-slate-50 border-b-slate-300'}`}
                  >
                    ...
                    <h3 className={`font-black text-[15px] leading-tight ${isLocked ? 'text-slate-400' : 'text-slate-800'}`}>
                      {exam.title}
                    </h3>
            ...
            >
              <h3 className="text-xl font-black text-slate-800 mb-2">Nada por aquí</h3>
              <p className="text-[14px] font-bold text-slate-400">Cambia de pestaña para ver otros exámenes.</p>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
