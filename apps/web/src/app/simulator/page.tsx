...
export default function SimulatorPage() {
  ...
  const getPreguntaData = (id: number) => {
    const lecturaTexto1 =
      'La inteligencia artificial (IA) generativa es una rama de la informática que se enfoca en crear sistemas capaces de originar texto, imágenes u otros medios a partir de patrones aprendidos. A diferencia de la IA tradicional, que está diseñada para clasificar o predecir datos existentes, la IA generativa produce contenido completamente nuevo y original. Sin embargo, esto plantea grandes dilemas éticos sobre la propiedad intelectual y la veracidad de la información.';

    const db: Record<number, any> = {
      1: {
        area: 'RAZONAMIENTO VERBAL',
        texto:
          'Señale el sinónimo de la palabra subrayada: El comportamiento del reo fue EXECRABLE durante el juicio.',
        resaltar: 'EXECRABLE',
        opciones: [
      ...
      2: {
        ...
        texto:
          'Determine el número que continúa en la siguiente sucesión: 2, 5, 10, 17, 26, ...',
        opciones: [
          { letra: 'A', texto: '35' },
          { letra: 'B', texto: '37' },
          { letra: 'C', texto: '39' },
      ...
      3: {
        ...
        texto:
          'Según el texto, ¿cuál es la diferencia principal entre la IA generativa y la IA tradicional?',
        opciones: [
          { letra: 'A', texto: 'La IA tradicional no utiliza algoritmos.' },
          {
            letra: 'B',
            texto:
              'La IA generativa produce contenido nuevo, mientras que la tradicional clasifica o predice datos.',
          },
          {
            letra: 'C',
            texto: 'La IA generativa solo crea imágenes, no textos.',
          },
          {
            letra: 'D',
            texto: 'No existe ninguna diferencia significativa entre ambas.',
          },
          {
            letra: 'E',
            texto: 'La IA tradicional es más moderna que la IA generativa.',
          },
        ],
        etiqueta: 'TEXTO 1',
      },
      4: {
        ...
        contexto: lecturaTexto1,
        texto:
          'De la lectura se puede inferir que el avance de la IA generativa:',
        opciones: [
          {
            letra: 'A',
            texto:
              'Ha resuelto todos los problemas de la propiedad intelectual.',
          },
          { letra: 'B', texto: 'Solo es útil para predecir datos existentes.' },
          {
            letra: 'C',
            texto: 'Viene acompañado de importantes debates éticos.',
          },
          { letra: 'D', texto: 'Es un retroceso para la informática moderna.' },
          {
            letra: 'E',
            texto: 'Ha reemplazado por completo a la inteligencia humana.',
          },
        ],
        etiqueta: 'TEXTO 1',
      },
